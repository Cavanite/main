...
if (Test-Path -Path "C:\Temp") {
    ...
    $SigninLogs | Export-Csv -Path "C:\Temp\LastSignIn.csv" -NoTypeInformation
    Write-Host "Successfully exported to CSV, at location C:\Temp\LastSignIn.csv" -ForegroundColor Green
} else {
